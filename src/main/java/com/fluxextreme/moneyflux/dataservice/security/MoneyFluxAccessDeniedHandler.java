...
@Component
public class MoneyFluxAccessDeniedHandler implements AccessDeniedHandler {

	private static Logger logger = LoggerFactory.getLogger(MoneyFluxAccessDeniedHandler.class);
